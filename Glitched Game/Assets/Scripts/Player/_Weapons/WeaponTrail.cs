...
public class WeaponTrail : MonoBehaviour
{
	...
	/*
	 ...
	 2. Attach a MeshRenderer and this script
	 3. Assign a material to the mesh renderer
	 4. Call its Iterate method everytime you sample the animation (if you want a smooth trail this should be more than once a frame)
	 5. Call its UpdateTrail method once a frame to rebuild the mesh
	*/
#region Public
