...
/*SF_DATA;ver:1.38;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:0,cgin:,lico:1,lgpr:1,limd:3,spmd:1,trmd:0,grmd:0,uamb:True,mssp:True,bkdf:True,hqlp:False,rprd:True,enco:False,rmgx:True,imps:True,rpth:0,vtps:0,hqsc:False,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:0,bsrc:0,bdst:1,dpts:2,wrdp:True,dith:0,atcv:False,rfrpo:False,rfrpn:Refraction,coma:15,ufog:True,aust:True,igpj:False,qofs:0,qpre:2,rntp:3,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,atwp:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:False,fnfb:False,fsmp:False;n:type:ShaderForge.SFN_Final,id:2865,x:33129,y:33428,varname:node_2865,prsc:2|diff-4772-OUT,spec-3622-OUT,gloss-3584-OUT,normal-1139-RGB,emission-8597-OUT,difocc-5059-OUT,clip-7705-OUT;n:type:ShaderForge.SFN_Multiply,id:4772,x:30824,y:32335,varname:node_4772,prsc:2|A-6536-RGB,B-6453-OUT;n:type:ShaderForge.SFN_Tex2d,id:6536,x:30117,y:32207,ptovrint:True,ptlb:Base Color,ptin:_MainTex,varname:_MainTex,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:61d687ff60e527f49836193096195ca8,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Slider,id:4596,x:31018,y:32667,ptovrint:False,ptlb:Metallic Intensity,ptin:_MetallicIntensity,varname:_MetallicIntensity,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:5,max:5;n:type:ShaderForge.SFN_Slider,id:3584,x:31011,y:32840,ptovrint:False,ptlb:Gloss Intensity,ptin:_GlossIntensity,varname:_GlossIntensity,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:1,max:5;n:type:ShaderForge.SFN_Fresnel,id:5629,x:27669,y:31936,varname:node_5629,prsc:2|EXP-6759-OUT;n:type:ShaderForge.SFN_Slider,id:6759,x:27075,y:32073,ptovrint:False,ptlb:FresnelValue,ptin:_FresnelValue,varname:_FresnelValue,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:-1,cur:0.920527,max:3;n:type:ShaderForge.SFN_Multiply,id:8516,x:29316,y:33034,varname:node_8516,prsc:2|A-3288-OUT,B-5629-OUT,C-2033-OUT,D-7742-OUT;n:type:ShaderForge.SFN_SwitchProperty,id:3288,x:27612,y:31694,ptovrint:False,ptlb:GlowToggle,ptin:_GlowToggle,varname:_GlowToggle,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,on:False|A-7712-OUT,B-6069-OUT;n:type:ShaderForge.SFN_Vector1,id:7712,x:27124,y:31640,varname:node_7712,prsc:2,v1:0;n:type:ShaderForge.SFN_Vector1,id:6069,x:27124,y:31771,varname:node_6069,prsc:2,v1:1;n:type:ShaderForge.SFN_Color,id:8709,x:27643,y:32649,ptovrint:False,ptlb:DamageColor,ptin:_DamageColor,varname:_DamageColor,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:1,c2:0.1985294,c3:0.1985294,c4:1;n:type:ShaderForge.SFN_Color,id:4605,x:27643,y:32823,ptovrint:False,ptlb:StunColor,ptin:_StunColor,varname:_StunColor,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:0.988641,c2:1,c3:0.1764706,c4:1;n:type:ShaderForge.SFN_SwitchProperty,id:2033,x:27849,y:32720,ptovrint:False,ptlb:Damage or Stun,ptin:_DamageorStun,varname:_DamageorStun,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,on:False|A-8709-RGB,B-4605-RGB;n:type:ShaderForge.SFN_Tex2dAsset,id:9741,x:27150,y:32569,ptovrint:False,ptlb:DamageNoiseTex,ptin:_DamageNoiseTex,varname:_DamageNoiseTex,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:e958c6041cfe445e987c73751e8d4082,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Panner,id:8764,x:27171,y:32299,varname:node_8764,prsc:2,spu:0.5,spv:1|UVIN-2903-UVOUT;n:type:ShaderForge.SFN_TexCoord,id:2903,x:26873,y:32145,varname:node_2903,prsc:2,uv:0,uaff:False;n:type:ShaderForge.SFN_Tex2d,id:2250,x:27788,y:32413,varname:node_483,prsc:2,tex:e958c6041cfe445e987c73751e8d4082,ntxv:0,isnm:False|UVIN-8764-UVOUT,TEX-9741-TEX;n:type:ShaderForge.SFN_Slider,id:9867,x:27310,y:32613,ptovrint:False,ptlb:NoiseIntensity,ptin:_NoiseIntensity,varname:_NoiseIntensity,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:5,max:5;n:type:ShaderForge.SFN_Multiply,id:7742,x:28287,y:32334,varname:node_7742,prsc:2|A-2250-R,B-9867-OUT;n:type:ShaderForge.SFN_Time,id:7497,x:28860,y:34076,varname:node_7497,prsc:2;n:type:ShaderForge.SFN_Multiply,id:7244,x:29136,y:33848,varname:node_7244,prsc:2|A-7207-OUT,B-7497-T;n:type:ShaderForge.SFN_Slider,id:7207,x:28720,y:33798,ptovrint:False,ptlb:NoisePanSpeed,ptin:_NoisePanSpeed,varname:_NoisePanSpeed,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:1.014065,max:3;n:type:ShaderForge.SFN_Add,id:1347,x:31015,y:33199,varname:node_1347,prsc:2|A-4813-OUT,B-8516-OUT;n:type:ShaderForge.SFN_Tex2d,id:6801,x:30004,y:32994,ptovrint:False,ptlb:Emission,ptin:_Emission,varname:_Emission,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:ea27c133265bdcb40a65a0b25ecd70e6,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Multiply,id:4813,x:30643,y:32992,varname:node_4813,prsc:2|A-3826-OUT,B-6801-RGB;n:type:ShaderForge.SFN_Slider,id:3826,x:29934,y:32724,ptovrint:False,ptlb:EmissionIntensity,ptin:_EmissionIntensity,varname:_EmissionIntensity,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:1,max:1;n:type:ShaderForge.SFN_Tex2d,id:1139,x:31522,y:32925,ptovrint:False,ptlb:NormalMap,ptin:_NormalMap,varname:_NormalMap,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:ddb0d502a41ab9b4c9de7fee938edc75,ntxv:2,isnm:False;n:type:ShaderForge.SFN_Tex2d,id:8470,x:31772,y:33071,ptovrint:False,ptlb:Occlusion,ptin:_Occlusion,varname:_Occlusion,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:edfc42f1cb2677b40b7df2296641d810,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Multiply,id:5059,x:31862,y:33314,varname:node_5059,prsc:2|A-8470-R,B-4524-OUT;n:type:ShaderForge.SFN_Slider,id:4524,x:31443,y:33373,ptovrint:False,ptlb:OcclusionIntensity,ptin:_OcclusionIntensity,varname:_OcclusionIntensity,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:1.953,max:10;n:type:ShaderForge.SFN_Slider,id:6453,x:30306,y:32566,ptovrint:False,ptlb:AlbedoIntensity,ptin:_AlbedoIntensity,varname:_AlbedoIntensity,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:1,max:5;n:type:ShaderForge.SFN_Tex2d,id:49,x:31143,y:32434,ptovrint:False,ptlb:MetallicMap,ptin:_MetallicMap,varname:_MetallicMap,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:ad4d155eeb40b0243b626a9b5b19af87,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Multiply,id:3622,x:31517,y:32574,varname:node_3622,prsc:2|A-49-R,B-4596-OUT;n:type:ShaderForge.SFN_Tex2d,id:5924,x:30465,y:33997,ptovrint:False,ptlb:node_7077,ptin:_node_7077,varname:_node_7077,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:bbe85db2f82fe604084455e03c6794c3,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Add,id:7705,x:30827,y:33948,varname:node_7705,prsc:2|A-2819-OUT,B-5924-R;n:type:ShaderForge.SFN_Slider,id:559,x:29710,y:34418,ptovrint:False,ptlb:DissolveAmount,ptin:_DissolveAmount,varname:_DissolveAmount,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:1,max:1.5;n:type:ShaderForge.SFN_RemapRange,id:2819,x:29972,y:33929,varname:node_2819,prsc:2,frmn:0,frmx:1,tomn:-0.6,tomx:0.6|IN-559-OUT;n:type:ShaderForge.SFN_RemapRange,id:2664,x:31047,y:33597,varname:node_2664,prsc:2,frmn:0,frmx:1,tomn:-1,tomx:1|IN-7705-OUT;n:type:ShaderForge.SFN_Clamp01,id:9439,x:31389,y:33613,varname:node_9439,prsc:2|IN-2664-OUT;n:type:ShaderForge.SFN_Append,id:7127,x:31656,y:33601,varname:node_7127,prsc:2|A-9439-OUT,B-3620-OUT;n:type:ShaderForge.SFN_Vector1,id:3620,x:31378,y:33766,varname:node_3620,prsc:2,v1:0;n:type:ShaderForge.SFN_Tex2d,id:2363,x:31899,y:33718,varname:node_2363,prsc:2,tex:271f5ee3273dd7f4fae6e204d4f8c4bf,ntxv:0,isnm:False|UVIN-7127-OUT,TEX-4382-TEX;n:type:ShaderForge.SFN_Tex2dAsset,id:4382,x:31455,y:33901,ptovrint:False,ptlb:node_4382,ptin:_node_4382,varname:_node_4382,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:271f5ee3273dd7f4fae6e204d4f8c4bf,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Add,id:8597,x:32691,y:33614,varname:node_8597,prsc:2|A-1347-OUT,B-5649-OUT;n:type:ShaderForge.SFN_Multiply,id:5649,x:32255,y:33920,varname:node_5649,prsc:2|A-2363-RGB,B-8753-OUT;n:type:ShaderForge.SFN_OneMinus,id:8753,x:30350,y:34299,varname:node_8753,prsc:2|IN-559-OUT;proporder:6536-6453-1139-6801-3826-49-4596-3584-8470-4524-3288-6759-9741-9867-8709-4605-2033-5924-559-4382;pass:END;sub:END;*/
...
Shader "Shader Forge/EnemyShaderv2" {
    Properties {
        ...
        _DissolveAmount ("DissolveAmount", Range(0, 1.5)) = 1
...
////// Emissive:
                ...
                float4 node_4142 = _Time;
                float2 node_8764 = (i.uv0+node_4142.g*float2(0.5,1));
                float4 node_483 = tex2D(_DamageNoiseTex,TRANSFORM_TEX(node_8764, _DamageNoiseTex));
                float2 node_7127 = float2(saturate((((_DissolveAmount*1.2+-0.6)+_node_7077_var.r)*2.0+-1.0)),0.0);
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float4 _Emission_var = tex2D(_Emission,TRANSFORM_TEX(i.uv0, _Emission));
                float4 node_6681 = _Time;
                float2 node_8764 = (i.uv0+node_6681.g*float2(0.5,1));
                float4 node_483 = tex2D(_DamageNoiseTex,TRANSFORM_TEX(node_8764, _DamageNoiseTex));
                float4 _node_7077_var = tex2D(_node_7077,TRANSFORM_TEX(i.uv0, _node_7077));
                float2 node_7127 = float2(saturate((((_DissolveAmount*1.2+-0.6)+_node_7077_var.r)*2.0+-1.0)),0.0);
                float4 node_2363 = tex2D(_node_4382,TRANSFORM_TEX(node_7127, _node_4382));
