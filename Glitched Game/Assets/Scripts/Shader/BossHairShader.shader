    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float node_2099 = ((node_7387.r*_VertexAnimationIntensity)+(node_7867.g*_VertexAnimationMask));
