    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float2 sceneUVs = (i.projPos.xy / i.projPos.w) + UVFixforvive( (_Refraction_var.rgb.rg*(_RefractionIntensity*0.2)) );
